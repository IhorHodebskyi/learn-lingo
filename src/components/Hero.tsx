...
export default function Hero({}: HeroProps) {
	return (
		<div className="flex justify-around items-center max-w-[1312px]  m-auto gap-6 ">
			<div className="bg-gray-100 rounded-[30px] max-w-[720px] h-[530px] py-[98px] px-[64px]">
				...
				<NavLink
					className="px-[88px] py-[16px] bg-amber-400 hover:bg-amber-300 rounded-xl  duration-300 ease-in-out"
					to={""}
				>
					Get started
				</NavLink>
